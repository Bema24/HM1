...
public class Main {
    ...
    public static void main(String[] args) {
      ...
      /*  Father father = new Father("Kolin",33,new PlaceOfResidence("Ул Токтогула"),Profession.BUILDER);
        ...
        Father Denil = new Father("Denil",22,new PlaceOfResidence("Правда"),Profession.BUILDER);
        Son Alex = new Son("Alex",15,new PlaceOfResidence("Ул Панфилова"),Profession.PART_TIME_JOB);
        Son Johni = new Son("Johni",19,new PlaceOfResidence("Ул Гагарина"),Profession.PART_TIME_JOB);
